...
renderView1.CameraPosition = [135.08752669482396, 108.02591982684889, -359.4119894444987]
renderView1.CameraFocalPoint = [65.36662292480463, 64.00000000000003, 63.9999999999999]
renderView1.CameraViewUp = [0.9796996916964371, -0.13612583029147762, 0.1471674978293856]
...
washmc_ = VisItPixieReader(registrationName='washmc_*', FileName='C:\\Users\\Mike\\data\\washmc-data\\uni1\\h5\\washmc_881000.h5')
...
slice1.SliceType.Origin = [60.492079008563984, 64.0, 64.0]
...
# generate extracts
#SaveExtracts(ExtractsOutputDirectory='C:\Users\Mike\data\washmc-data\uni1\h5')
