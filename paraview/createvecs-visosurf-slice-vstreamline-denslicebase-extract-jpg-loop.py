...
def createimage(i,renderView1):
    ...
    washmc_ = VisItPixieReader(registrationName='washmc_*',FileName=fname)
    ...
    vz_sub_slice_y.SliceType.Origin = [32.0, 64.0, 64.0]
    ...
    # init the 'Plane' selected for 'SliceType'
    denspertsubsetslice.SliceType.Origin = [2.587724133783338, 64.0, 64.0]
    ...
    datagrid_0000000000density_pertLUT.RGBPoints = [-2.542480900048402e-06, 0.231373, 0.298039, 0.752941, -1.079030772803246e-07, 0.865003, 0.865003, 0.865003, 2.3266747454877528e-06, 0.705882, 0.0156863, 0.14902]
    ...
    datagrid_0000000000velocity_zLUT.RGBPoints = [-0.0027277640191690194, 0.231373, 0.298039, 0.752941, 0.00239560308350306, 0.865003, 0.865003, 0.865003, 0.007518970186175139, 0.705882, 0.0156863, 0.14902]
    ...
    # show data from vz_sub_slice_y
    vz_sub_slice_yDisplay = Show(vz_sub_slice_y, renderView1, 'GeometryRepresentation')

    # trace defaults for the display properties.
    vz_sub_slice_yDisplay.Representation = 'Surface'
    vz_sub_slice_yDisplay.ColorArrayName = ['CELLS', 'data/grid_0000000000/velocity_z']
    vz_sub_slice_yDisplay.LookupTable = datagrid_0000000000velocity_zLUT
    vz_sub_slice_yDisplay.Opacity = 0.49
    vz_sub_slice_yDisplay.SelectTCoordArray = 'None'
    vz_sub_slice_yDisplay.SelectNormalArray = 'None'
    vz_sub_slice_yDisplay.SelectTangentArray = 'None'
    vz_sub_slice_yDisplay.OSPRayScaleFunction = 'PiecewiseFunction'
    vz_sub_slice_yDisplay.SelectOrientationVectors = 'None'
    vz_sub_slice_yDisplay.ScaleFactor = 12.8
    vz_sub_slice_yDisplay.SelectScaleArray = 'None'
    vz_sub_slice_yDisplay.GlyphType = 'Arrow'
    vz_sub_slice_yDisplay.GlyphTableIndexArray = 'None'
    vz_sub_slice_yDisplay.GaussianRadius = 0.64
    vz_sub_slice_yDisplay.SetScaleArray = [None, '']
    vz_sub_slice_yDisplay.ScaleTransferFunction = 'PiecewiseFunction'
    vz_sub_slice_yDisplay.OpacityArray = [None, '']
    vz_sub_slice_yDisplay.OpacityTransferFunction = 'PiecewiseFunction'
    vz_sub_slice_yDisplay.DataAxesGrid = 'GridAxesRepresentation'
    vz_sub_slice_yDisplay.PolarAxes = 'PolarAxesRepresentation'

    # show data from vz_sub_slice_z
    vz_sub_slice_zDisplay = Show(vz_sub_slice_z, renderView1, 'GeometryRepresentation')

    # trace defaults for the display properties.
    vz_sub_slice_zDisplay.Representation = 'Surface'
    vz_sub_slice_zDisplay.ColorArrayName = ['CELLS', 'data/grid_0000000000/velocity_z']
    vz_sub_slice_zDisplay.LookupTable = datagrid_0000000000velocity_zLUT
    vz_sub_slice_zDisplay.Opacity = 0.54
    vz_sub_slice_zDisplay.SelectTCoordArray = 'None'
    vz_sub_slice_zDisplay.SelectNormalArray = 'None'
    vz_sub_slice_zDisplay.SelectTangentArray = 'None'
    vz_sub_slice_zDisplay.OSPRayScaleFunction = 'PiecewiseFunction'
    vz_sub_slice_zDisplay.SelectOrientationVectors = 'None'
    vz_sub_slice_zDisplay.ScaleFactor = 12.8
    vz_sub_slice_zDisplay.SelectScaleArray = 'None'
    vz_sub_slice_zDisplay.GlyphType = 'Arrow'
    vz_sub_slice_zDisplay.GlyphTableIndexArray = 'None'
    vz_sub_slice_zDisplay.GaussianRadius = 0.64
    vz_sub_slice_zDisplay.SetScaleArray = [None, '']
    vz_sub_slice_zDisplay.ScaleTransferFunction = 'PiecewiseFunction'
    vz_sub_slice_zDisplay.OpacityArray = [None, '']
    vz_sub_slice_zDisplay.OpacityTransferFunction = 'PiecewiseFunction'
    vz_sub_slice_zDisplay.DataAxesGrid = 'GridAxesRepresentation'
    vz_sub_slice_zDisplay.PolarAxes = 'PolarAxesRepresentation'
    ...
    # show color legend
    vz_sub_slice_yDisplay.SetScalarBarVisibility(renderView1, True)

    # show color legend
    vz_sub_slice_zDisplay.SetScalarBarVisibility(renderView1, True)
    ...
    datagrid_0000000000velocity_zPWF.Points = [-0.0027277640191690194, 0.0, 0.5, 0.0, 0.007518970186175139, 1.0, 0.5, 0.0]
    ...
    datagrid_0000000000density_pertPWF.Points = [-2.542480900048402e-06, 0.0, 0.5, 0.0, 2.3266747454877528e-06, 1.0, 0.5, 0.0]
    datagrid_0000000000density_pertPWF.ScalarRangeInitialized = 1

    # ----------------------------------------------------------------
    # restore active source
    SetActiveSource(vsubtube)
    # ----------------------------------------------------------------
...
renderView1.CameraPosition = [65.30442873666493, 8.34071248540046, 194.9824124747493]
renderView1.CameraFocalPoint = [25.460024097228867, 57.01995351030991, 73.87102511564524]
renderView1.CameraViewUp = [0.956189250733063, 0.0879554139530039, -0.27922385632123053]
