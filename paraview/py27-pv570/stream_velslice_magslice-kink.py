...
# show data from slice2
slice2Display_1 = Show(slice2, renderView2)

# trace defaults for the display properties.
slice2Display_1.Representation = 'Surface'
slice2Display_1.ColorArrayName = ['CELLS', 'bt']
slice2Display_1.LookupTable = btLUT
slice2Display_1.OSPRayScaleFunction = 'PiecewiseFunction'
slice2Display_1.SelectOrientationVectors = 'bt'
slice2Display_1.ScaleFactor = 12.8
slice2Display_1.SelectScaleArray = 'None'
slice2Display_1.GlyphType = 'Arrow'
slice2Display_1.GlyphTableIndexArray = 'None'
slice2Display_1.GaussianRadius = 0.64
...
# show color legend
slice2Display_1.SetScalarBarVisibility(renderView2, True)
