...
def createimage(i,renderView1):
    ...
    streamTracer1.SeedType.Center = [-1.4922006071443983, 64.4255949983666, 58.92625442240572]
    ...
    datagrid_0000000000velocity_zLUT.RGBPoints = [-0.009707228867535144, 0.231373, 0.298039, 0.752941, -0.0030487548297573816, 0.865003, 0.865003, 0.865003, 0.0036097192080203813, 0.705882, 0.0156863, 0.14902]
    ...
    velLUT.RGBPoints = [3.0533740552814475e-08, 0.231373, 0.298039, 0.752941, 0.05869883690822947, 0.865003, 0.865003, 0.865003, 0.11739764328271839, 0.705882, 0.0156863, 0.14902]
    ...
    datagrid_0000000000velocity_zPWF.Points = [-0.009707228867535144, 0.0, 0.5, 0.0, 0.0036097192080203813, 1.0, 0.5, 0.0]
    ...
    velPWF.Points = [3.0533740552814475e-08, 0.0, 0.5, 0.0, 0.11739764328271839, 1.0, 0.5, 0.0]
...
renderView1.CameraPosition = [40.356388357592074, -45.23300058035567, -114.81997465283165]
renderView1.CameraFocalPoint = [31.511067837477047, 63.99999999999936, 63.999999999999915]
renderView1.CameraViewUp = [0.9986259947969038, -0.004591788201063419, 0.05220189648864349]
