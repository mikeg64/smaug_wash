...
def createimage(i,renderView1):
    ...
    vz_sub_slice_yDisplay.Opacity = 0.76
    ...
    vz_sub_slice_zDisplay.Opacity = 0.76
...
for i in range(0,64): 
    ...
    renderView1.CenterOfRotation = [63.99183115363121, 64.0, 64.0]
    renderView1.StereoType = 'Crystal Eyes'
    renderView1.CameraPosition = [66.79603417050178, 184.4540984209747, -11.756307960367263]
    renderView1.CameraFocalPoint = [25.505726304443378, 74.66461225087045, 58.00465848013081]
    renderView1.CameraViewUp = [0.9504201930887488, -0.21419642968832328, 0.22543590237120786]
    renderView1.CameraFocalDisk = 1.0
    renderView1.CameraParallelScale = 110.85596817070905
    renderView1.BackEnd = 'OSPRay raycaster'
    renderView1.OSPRayMaterialLibrary = materialLibrary1
