...
n1=128
n2=128
wdt1v=dblarr(nt+1,n1,4)
wdt1h=dblarr(nt+1,n2,4,2)
window, 0,xsize=1025,ysize=1025,XPOS = 950, YPOS = 300 
window, 1,xsize=900,ysize=900,XPOS = 500, YPOS = 80


;for ipic=pic,489000 do begin
;for ipic=280,489 do begin
for ipic=1,nt do begin
...
;directory='/data/cs1mkg/smaug_spicule1/spicule4b0_3d/'
directory='/fastdata/cs1mkg/smaug/spic4b0_2_3d/'
;directory='/data/cs1mkg/smaug_spicule1/spicule4b0_3d/'
...
myrange=[zz(0)/1.0d6,zz(n1-1)/1.0d6]
mxrange=[xx(0)/1.0d6,xx(n2-1)/1.0d6]
mtrange=[0,picid*dt]
...
tvframe,rotate(wy(*,*,1)/(wy(*,*,0)+wy(*,*,9)),1),/sample, /bar,title='Vz - x plane', $
        xtitle='y', ytitle='z',charsize=1.0, xrange=mxrange, yrange=myrange;, brange=mv1range ;, title='dPdT'

tvframe,rotate(wt(*,*,1)/(wt(*,*,0)+wt(*,*,9)),1),/sample, /bar,title='Vz  - y plane', $
        xtitle='x', ytitle='z',charsize=1.0, xrange=mxrange, yrange=myrange;, brange=mv1range ; CT='dPdT'
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic4b0_2_3d/s4b0_2_3d'+indexss+'.png',image_p, red,green, blue
...
;image_p = TVRD_24()
;write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spicule4b0_3d/pm300s_sindrv_n0_4b03d_vdt.png',image_p, red,green, blue


;save,wdt1har,filename='wdt1var_4b03d.dat'


tvframe,wdt1h(*,*,1,0), /bar,title='v1 at 0.94Mm',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 
;tvframe,wdt1h(*,*,2,0), /bar,title='v2',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 
;write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spicule4b0_b4_3d/pm300s_sindrv_n0_4b03d_h0dt.png',image_p, red,green, blue
...
tvframe,wdt1h(*,*,2,0), /bar,title='v2 at 0.94Mm',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 
;tvframe,wdt1h(*,*,2,1), /bar,title='v2',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 


image_p = TVRD_24()

write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic4b0_2_3d/pm30s_sindrv_4b0_2_3d_h1dt.png',image_p, red,green, blue
...
tvframe,wdt1h(*,*,1,0), /bar,title='v1 at 0.94Mm',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 
tvframe,wdt1h(*,*,3,0), /bar,title='bx at 0.94Mm',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 

image_p = TVRD_24()

write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic4b0_2_3d/pmb30s_sindrv_4b0_2_3d_h1dt.png',image_p, red,green, blue
...
;save,wdt1har,filename='wdt1har_4b03d.dat'
