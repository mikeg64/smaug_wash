...
directory='/fastdata/cs1mkg/smaug/spicule5_nob/'
;pic=999
name='zerospic1_'
;ndim=2
;n1=800
...
wdt(ipic,*,0)=w(nsect1,*,0)
wdt(ipic,*,1)=w(nsect1,*,1)
wdt(ipic,*,2)=w(nsect1,*,2)
wdt(ipic,*,3)=w(nsect1,*,3)
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic5/spic'+indexss+'.png',image_p, red,green, blue
;stop
;endwhile
close,1
endfor
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic5/spic_384_dt.png',image_p, red,green, blue

for i=0,n1-1 do begin

   wfft(*,i,0)=fft(wdt(*,i,0))
   wfft(*,i,1)=fft(wdt(*,i,1))
   wfft(*,i,2)=fft(wdt(*,i,2))
   wfft(*,i,3)=fft(wdt(*,i,3))


endfor

tvframe,wfft(*,*,1), /bar,title='v1',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=mxrange 
tvframe,wfft(*,*,2), /bar,title='v2',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=mxrange 
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic5/spic_fft.png',image_p, red,green, blue
