...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic7/spic'+indexss+'.png',image_p, red,green, blue
;stop
;endwhile
close,1
endfor
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic7/spic_384_dt.png',image_p, red,green, blue
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic7/spic_fft.png',image_p, red,green, blue
