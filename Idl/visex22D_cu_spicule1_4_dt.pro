...
wdtv1a=dblarr(pic+1,2)
wdtv1b=dblarr(pic+1,2)
wdtv1c=dblarr(pic+1,2)
wdtv1d=dblarr(pic+1,2)
wdtv1e=dblarr(pic+1,2)

wdtv1ar=dblarr(11,pic+1,2)
...
;directory='/fastdata/cs1mkg/smaug/spicule5b0_nob/'
;directory='/fastdata/cs1mkg/smaug/scnstrh5b0a_nob/'
;directory='/fastdata/cs1mkg/smaug/spicule5b0nog_nob/'
directory='/fastdata/cs1mkg/smaug/conrng5b0a_nob/'
;pic=999
name='zerospic1__'
;name='zerospic1_'
...
;1.1Mm
wdtv1(ipic,0)=w(511,188,1)/(w(511,188,0)+w(511,188,7))
wdtv1(ipic,1)=w(511,188,2)/(w(511,188,0)+w(511,188,7))

wdtv1a(ipic,0)=w(511,341,1)/(w(511,341,0)+w(511,341,7))
wdtv1a(ipic,1)=w(511,341,2)/(w(511,341,0)+w(511,341,7))

wdtv1b(ipic,0)=w(511,683,1)/(w(511,683,0)+w(511,683,7))
wdtv1b(ipic,1)=w(511,683,2)/(w(511,683,0)+w(511,683,7))

wdtv1c(ipic,0)=w(511,1024,1)/(w(511,1024,0)+w(511,1024,7))
wdtv1c(ipic,1)=w(511,1024,2)/(w(511,1024,0)+w(511,1024,7))

wdtv1d(ipic,0)=w(511,1365,1)/(w(511,1365,0)+w(511,1365,7))
wdtv1d(ipic,1)=w(511,1365,2)/(w(511,1365,0)+w(511,1365,7))

wdtv1e(ipic,0)=w(511,1706,1)/(w(511,1706,0)+w(511,1706,7))
wdtv1e(ipic,1)=w(511,1706,2)/(w(511,1706,0)+w(511,1706,7))

for iw=0,10 do begin
 iwi=188+iw*150
 wdtv1ar(iw,ipic,0)=w(511,iwi,1)/(w(511,iwi,0)+w(511,iwi,7))
 wdtv1ar(iw,ipic,1)=w(511,iwi,2)/(w(511,iwi,0)+w(511,iwi,7))
endfor
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/conrng5b0a/pm300s__sindrv_crng_n0_5b0a'+indexss+'.png',image_p, red,green, blue
;stop
;endwhile
close,1
endfor
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/conrng5b0a/pm300s__sindrv_crng_n0_5b0a1p5Mm_hdt.png',image_p, red,green, blue
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/conrng5b0a/pm300s__sindrv_crng_n0_5b0a2Mm_vtrandt.png',image_p, red,green, blue
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/conrng5b0a/pm300s__sindrv_crng_n0_5b0a4p5Mm_hdt.png',image_p, red,green, blue
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/conrng5b0a/pm300s__sindrv_crng_n0_5b0a3Mm_vdt.png',image_p, red,green, blue


save,wdt1var,filename='wdt1var_conrng5b0a.dat'


;save,wdt1v,filename='wdt1v_scnstr5b0b.dat'
;save,wdtv1,filename='wdtv1_scnstr5b0b.dat'
;save,wdtv1a,filename='wdtv1a_scnstr5b0b.dat'
;save,wdtv1b,filename='wdtv1b_scnstr5b0b.dat'
;save,wdtv1c,filename='wdtv1c_scnstr5b0b.dat'
;save,wdtv1d,filename='wdtv1d_scnstr5b0b.dat'
;save,wdtv1e,filename='wdtv1e_scnstr5b0b.dat'

plot,wdtv1(*,0)
tvframe,wdt1v(*,*,1),xrange=mtrange,yrange=myrange

image_p = TVRD_24()
;;;write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic5b0/pmode300s__sindriver_n0_5b0period.png',image_p, red,green, blue
...
tvframe,wfft1(*,*,1), /bar,title='v1',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 
tvframe,wfft1(*,*,2), /bar,title='v2',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 
tvframe,wfft2(*,*,1), /bar,title='v1',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 
tvframe,wfft2(*,*,2), /bar,title='v2',/sample, xtitle='dt (sec)', ytitle='Height (Mm)',charsize=1.1, xrange=mtrange, yrange=myrange 
...
image_p = TVRD_24()
;;;write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic5b0/spic_fft.png',image_p, red,green, blue
