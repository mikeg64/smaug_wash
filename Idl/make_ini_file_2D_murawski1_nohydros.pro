...
for i=0,n1-1 do begin
  for j=0,n2-1 do begin
    ...
    ;w(i,j,3)=0.0
     ...
     w(i,j,3)=(     (  pe(i,j)-(bsq(i,j)/2) )/(gamma-1))+(bsq(i,j)/2)
     w(i,j,6)=0.0
 endfor
endfor
...
;openw,1,'/data/cs1mkg/smaug_spicule1/2D_spiculemuraw1_nohydros_tube_2048_1024_asc.ini',/f77_unf
openw,1,'/data/cs1mkg/VAC_NN_tests/2D_spiculemuraw1_nohydros_nobg_tube_2048_1024_bin.ini',/f77_unf
