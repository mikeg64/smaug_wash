...
openr,1,'/data/cs1mkg/smaug_spicule1/spicule4b0_b1_3d/zerospic1__146000.out'
...
Contour, vz(100,*,*)/rho(100,*,*), x, y, /Fill, /NOERASE, C_Colors=Indgen(levels)+3, Background=1, /T3D,$
   Levels=userLevels, POSITION=[xx0, yy0, xx1, yy1, 0.1, 0.95], Color=black, ZVALUE = 0.80, $
   XSTYLE=1, YSTYLE=1, ZSTYLE=1, /NOCLIP,CHARSIZE=2.5, XRANGE=[mi_x, ma_x],  $
   YRANGE=[mi_y, ma_y], ZRANGE=[mi_z, ma_z]
