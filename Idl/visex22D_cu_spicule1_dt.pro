...
directory='/fastdata/cs1mkg/smaug/spicule6b0_nob/'
;pic=999
name='zerospic1__'
;name='zerospic1_'
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic6b0/pmode150s_sindriver_n0_6b0_2Mm_vdt.png',image_p, red,green, blue
...
image_p = TVRD_24()
write_png,'/data/cs1mkg/smaug_spicule1/Idl/images/spic6b0/pmode150s_sindriver_n0_6b0_3Mm_vdt.png',image_p, red,green, blue
...
for i=1,n1-1 do begin
   ...
   wfft(*,i,0)=fft(wdt1(*,i,0))
   wfft(*,i,1)=fft(wdt1(*,i,1))
   wfft(*,i,2)=fft(wdt1(*,i,2))
   wfft(*,i,3)=fft(wdt1(*,i,3))
