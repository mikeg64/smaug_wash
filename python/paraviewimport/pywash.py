...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.ViewSize = [960, 1090]
      renderView1.AxesGrid = 'GridAxes3DActor'
      renderView1.CenterOfRotation = [64.0, 64.0, 64.0]
      renderView1.StereoType = 'Crystal Eyes'
      renderView1.CameraPosition = [243.73142795693207, 402.4191485244801, -229.42529512929283]
      renderView1.CameraFocalPoint = [64.0000000000006, 64.00000000000023, 63.99999999999877]
      renderView1.CameraViewUp = [0.9280672260774541, -0.2793685433181821, 0.24626092033689956]
      ...
      coprocessor.RegisterView(renderView1,
          filename='image_%t.png', freq=1, fittoscreen=1, magnification=1, width=480, height=545, cinema={}, compression=-1)
      ...
      washmc_100000h5 = coprocessor.CreateProducer(datadescription, 'washmc_100000.h5')

      # create a new 'Calculator'
      vfieldcalc = Calculator(Input=washmc_100000h5)
      ...
      # create a new 'Calculator'
      bfieldcalc = Calculator(Input=washmc_100000h5)
  ...
  freqs = {'washmc_100000.h5': [1, 1, 1, 1, 1, 1, 1, 1]}
  ...
  if requestSpecificArrays:
    ...
    coprocessor.SetRequestedArrays('washmc_100000.h5', arrays)
