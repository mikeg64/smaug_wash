...
ndirectory='/fastdata/cs1mkg/smaug/washing_mach/images_vvecsurf/';
...
%plot sections through 3d array
  ...
  [x1,x3,x2] = meshgrid(1:8:124,6,1:8:124);
   nr1=6;
   nr2=1:8:124;
   nr3=1:8:124;
   ...
   val3=reshape(wd(2,nr1,nr2,nr3),snr1(2),snr2(2),snr3(2));
   uu=shiftdim(val3,1);
...
%    uv=shiftdim(val1./val2,1);
 ...
 val3=reshape(wd(3,nr1,nr2,nr3),snr1(2),snr2(2),snr3(2));
   uv=shiftdim(val3,1);
...
%    uw=shiftdim(val1./val2,1);
  ...
  val3=reshape(wd(4,nr1,nr2,nr3),snr1(2),snr2(2),snr3(2));
   uw=shiftdim(val3,1);   
...
uu=zeros(16,16);
mag=sqrt(uv.*uv+uw.*uw);
indmag=find(mag<0.01);
uv=uv./mag;
uw=uw./mag;
uv(indmag)=0;
uw(indmag)=0;
