...
%ptitle2=' Mode 300.0s (Horizontal Section in Chromosphere at 1Mm  x-dir)';
%ptitle2=' Mode 300.0s (Horizontal Section in Transition Layer at 2.06Mm  x-dir)';
ptitle2=' Mode 300.0s (Horizontal Section in Corona at 4.3Mm  x-dir)';
