...
wspacename=[rdirectory,'6b0_tranint.mat']

%load(wspacename);
%evelchrom_vh=zeros(nt,124);  %  horizontal section in chrom at  20
eveltran_vh=zeros(nt,124,124);   %  horizontal section in transition layer at 42
...
%    evelchrom_vh(i,:)=myval( 62,:,20);  %  horizontal section in chrom at  20
for il=40:47
    eveltran_vh(i,:,:)=eveltran_vh(i,:,:)+myval( :,:,il);   %  horizontal section in transition layer at 42
end
eveltran_vh(i,:,:)=eveltran_vh(i,:,:)./8;
%    evelcor_vh(i,:)=myval( 62,:,90);    %  horizontal section in corona at 90
