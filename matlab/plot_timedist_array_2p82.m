...
%0,0 mode
figure;
load('/fastdata/cs1mkg/smaug/matlabdat/spic2p82a_0_0_3d_ydir_vverustime.mat');
...
dtp00=dtplot;
smode='282s, (0,0) Mode Driver with no Vertical Magnetic Field.';
subplot(2,2,1);
...
load('/fastdata/cs1mkg/smaug/matlabdat/spic2p82a_0_0_b1v_ydir_vverustime.mat');
%dtplot=evelchrom_vh;  %  horizontal section in chrom at  20
%dtplot=eveltran_vh;   %  horizontal section in transition layer at 42
%dtplot=evelcor_vh;    %  horizontal section in corona at 90
...
dtp01=dtplot;
smode='282s, (0,0) Mode Driver with 1G Vertical Magnetic Field.';
subplot(2,2,2);
...
%figure;
%load('/fastdata/cs1mkg/smaug/matlabdat/spic6b0_3d_rep_vverustime.mat');
load('/fastdata/cs1mkg/smaug/matlabdat/spic2p82a_0_0_b20gv_ydir_vverustime.mat');
...
dtp02=dtplot;
smode='282s, (0,0) Mode Driver with 20G Vertical Magnetic Field.';
subplot(2,2,3);
...
dtp03=dtplot;
smode='282s, (0,0) Mode Driver with 50G Vertical Magnetic Field.';
subplot(2,2,4);
